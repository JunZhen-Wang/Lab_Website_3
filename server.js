...
app.get('/player_info', (req, res) => {
  ...
  app.get('/player_info/post', (req, res) => {
	  const players = 'SELECT * FROM football_players';
	  const playerId = "SELECT * FROM football_players WHERE name=\'" + req.query.player_choice + "\';";
	  const numGame = "select count(football_games.*) from football_players inner join football_games on football_players.id = any(football_games.players) where football_players.name=\'" + req.query.player_choice + "\';";
